        ...
        <div className="mx-auto flex max-w-[1200px] items-center justify-between gap-3 px-4 py-3">
          ...
          <nav className="hidden flex-1 items-center justify-center gap-1 lg:flex">
            ...
            <div className="relative">
              ...
              {openDd === "pricing" && (
                <div className="absolute left-0 top-f z-[60] min-w-[260px] animate-in fade-in slide-in-from-top-2 duration-200 rounded-2xl border border-slate-200/70 bg-white p-2 shadow-[0_18px_40px_rgba(2,6,23,.10)]">
