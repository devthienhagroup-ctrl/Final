          ...
          <div className="flex min-w-fit items-center gap-2 lg:min-w-[260px] lg:justify-end">
            ...
            {isAuthenticated ? (
              ...
              >
                <button
                  type="button"
                  className="inline-flex gap-2 rounded-full border border-slate-200 bg-white px-4 py-2 font-black text-slate-900 transition-all duration-200 hover:border-indigo-200 hover:bg-gradient-to-r hover:from-indigo-50 hover:to-purple-50 hover:text-indigo-700 hover:shadow-md"
                >
