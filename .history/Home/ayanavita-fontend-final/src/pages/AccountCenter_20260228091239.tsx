    ...
    <div className="mx-auto max-w-5xl space-y-6 p-6">
      ...
      <section className="rounded-2xl border border-slate-200 bg-white p-5">
        ...
        <form className="grid gap-4 md:grid-cols-2" onSubmit={onProfileSubmit}>
          ...
          <input className="rounded-xl border border-slate-300 bg-slate-100 px-3 py-2 text-slate-600" type="text" placeholder="Email" value={maskEmail(profile.email)} readOnly />
      ...
      <section className="rounded-2xl border border-slate-200 bg-white p-5">
        ...
        {forgotStep === "email" && (
          <form className="flex flex-col gap-4 md:flex-row" onSubmit={onSendForgotOtp}>
            <input className="flex-1 rounded-xl border border-slate-300 bg-slate-100 px-3 py-2 text-slate-600" type="text" placeholder="Email tài khoản" value={maskEmail(forgotForm.email)} />
