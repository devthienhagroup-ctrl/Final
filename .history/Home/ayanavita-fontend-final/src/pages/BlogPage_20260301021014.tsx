    ...
    return (
        <div className="text-slate-900 bg-slate-50 min-h-screen">
            ...
            <BlogHero
                ...
                onApply={() => { store.setPage(1); store.refresh(); }}
            ...
            {store.loading ? (
                <div className="max-w-7xl mx-auto px-4 mt-6 text-slate-600">Đang tải bài viết...</div>
            ) : null}

            <div className="max-w-7xl mx-auto px-4 mt-6 flex items-center justify-center gap-3">
                <button
                    className="btn"
                ...
                <span className="text-sm text-slate-600">
                    Trang {store.page}/{store.totalPages}
                </span>
                <button
                    className="btn"
