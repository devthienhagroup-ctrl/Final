...
export default function CartPage() {
  ...
  const [upsellProducts, setUpsellProducts] = useState<ApiUpsellProduct[]>([]);
...
// Tạo items với thông tin sản phẩm đầy đủ từ PRODUCTS
  ...
  async function onUpsellAdd(product: ApiUpsellProduct) {
                  ...
                  return (
                    ...
                    >
                      <img
                        ...
                        alt={p.name}
                        src={p.image || "https://placehold.co/640x360?text=Product"}
                      />
                      <div className="mt-3 font-extrabold">{p.name}</div>
                      <div className="text-sm text-slate-600 line-clamp-2">
                        {p.shortDescription || ""}
                      </div>
                      <div className="flex items-center justify-between mt-2 gap-">
                      <button
                      ...
                      <button type="button" className="flex-1 btn mt-3"><i className="fa-solid fa-info-circle text-slate-500"></i></button>
