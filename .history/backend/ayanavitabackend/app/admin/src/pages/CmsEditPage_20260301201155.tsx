...
function isImageKey(key: string | number): boolean {
  if (typeof key !== "string") return false;
  return key.toLowerCase().includes("img") || key.toLowerCase().includes("image") || key.toLowerCase().includes("image") || key.toLowerCase().includes("bgurl") || key.toLowerCase().includes("logo");
}
