...
const initialOrders: Order[] = [
    mkOrder("OD-1001", "Lan Nguyễn", "lan.nguyen@gmail.com", "2026-02-01", "paid", [
        item("Serum Vitamin C", "AYA-SERUM-VC", imgs.serum, 1, 289000),
        item("Sữa rửa mặt dịu nhẹ", "AYA-CLEAN-01", imgs.cleanser, 2, 129000),
    ]),
    mkOrder("OD-1002", "Minh Phạm", "minh.pham@outlook.com", "2026-02-02", "processing", [
        item("Kem chống nắng SPF50", "AYA-SUN-50", imgs.sunscreen, 1, 245000),
        item("Toner cấp ẩm", "AYA-TONER-H", imgs.toner, 1, 159000),
    ]),
    mkOrder("OD-1003", "Hà Trần", "ha.tran@gmail.com", "2026-02-02", "cancelled", [
        item("Kem dưỡng phục hồi", "AYA-CREAM-R", imgs.cream, 1, 329000),
    ]),
    mkOrder("OD-1004", "Tuấn Lê", "tuan.le@gmail.com", "2026-02-03", "paid", [
        item("Mặt nạ ngủ", "AYA-MASK-N", imgs.mask, 1, 199000),
        item("Toner cấp ẩm", "AYA-TONER-H", imgs.toner, 2, 159000),
    ]),
    mkOrder("OD-1005", "Vy Đặng", "vy.dang@gmail.com", "2026-02-05", "expired", [
        item("Kem chống nắng SPF50", "AYA-SUN-50", imgs.sunscreen, 2, 245000),
    ]),
    mkOrder("OD-1006", "Khoa Nguyễn", "khoa.nguyen@gmail.com", "2026-02-06", "paid", [
        item("Serum Niacinamide", "AYA-SERUM-N", imgs.serum, 1, 279000),
        item("Kem dưỡng phục hồi", "AYA-CREAM-R", imgs.cream, 1, 329000),
        item("Sữa rửa mặt dịu nhẹ", "AYA-CLEAN-01", imgs.cleanser, 1, 129000),
    ]),
    mkOrder("OD-1007", "Thảo Phan", "thao.phan@gmail.com", "2026-02-09", "processing", [
        item("Toner cấp ẩm", "AYA-TONER-H", imgs.toner, 1, 159000),
    ]),
    mkOrder("OD-1008", "Huy Trần", "huy.tran@yahoo.com", "2026-02-12", "paid", [
        item("Kem chống nắng SPF50", "AYA-SUN-50", imgs.sunscreen, 1, 245000),
        item("Mặt nạ ngủ", "AYA-MASK-N", imgs.mask, 2, 199000),
    ]),
    mkOrder("OD-1009", "Trang Lâm", "trang.lam@gmail.com", "2026-02-13", "paid", [
        item("Serum Vitamin C", "AYA-SERUM-VC", imgs.serum, 2, 289000),
    ]),
    mkOrder("OD-1010", "Đức Võ", "duc.vo@gmail.com", "2026-02-15", "cancelled", [
        item("Kem dưỡng phục hồi", "AYA-CREAM-R", imgs.cream, 1, 329000),
        item("Toner cấp ẩm", "AYA-TONER-H", imgs.toner, 1, 159000),
    ]),
    mkOrder("OD-1011", "Nhi Lê", "nhi.le@gmail.com", "2026-02-18", "processing", [
        item("Sữa rửa mặt dịu nhẹ", "AYA-CLEAN-01", imgs.cleanser, 3, 129000),
    ]),
    mkOrder("OD-1012", "Phong Đỗ", "phong.do@gmail.com", "2026-02-20", "paid", [
        item("Serum Niacinamide", "AYA-SERUM-N", imgs.serum, 1, 279000),
        item("Kem chống nắng SPF50", "AYA-SUN-50", imgs.sunscreen, 1, 245000),
    ]),
];
...
export default function AdminOrdersDemo() {
    ...
    const activeOrder = useMemo(
        () => (activeOrderCode ? orders.find((x) => x.code === activeOrderCode) ?? null : null),
        [activeOrderCode, orders],
    );
    ...
    function applyFilters(withToast: boolean) {
        setPage(1);
        if (withToast) toast(`Đã lọc: ${filtered.length} đơn`);
    }
    ...
    function resetFilters() {
        ...
        setActiveStatus("all");
        setPage(1);
        toast(`Đã lọc: ${orders.length} đơn`);
    }
    ...
    function markProcessing() {
        ...
        setOrders((prev) =>
            prev.map((o) => {
                if (o.code !== activeOrder.code) return o;
                const next: Order = {
                    ...o,
                    status: "processing",
                    payment: { ...o.payment, paidAt: null, ref: null },
                    confirmedBy: null,
                    shippingInfo: {
                        ...o.shippingInfo,
                        trackingCode: null,
                    ...
                    note: "Đơn mới tạo, chờ xác nhận tồn kho.",
                };
                return next;
            }),
        );
        toast("Đã cập nhật trạng thái (demo).");
        closeDrawer();
    }
    ...
    function markPaid() {
        ...
        setOrders((prev) =>
            prev.map((o) => {
                ...
                const ref = o.payment.ref || "TX-" + Math.floor(100000 + Math.random() * 900000);
                const confirmedBy = o.confirmedBy || "An";
                const trackingCode = o.shippingInfo.trackingCode || "TRK-" + Math.floor(100000 + Math.random() * 900000);
                const next: Order = {
                    ...o,
                    status: "paid",
                    payment: { ...o.payment, paidAt, ref },
                    confirmedBy,
                    shippingInfo: {
                        ...o.shippingInfo,
                        trackingCode,
                    ...
                    note: "Đã thanh toán, chuẩn bị đóng gói.",
                };
                return next;
            }),
        );
        toast("Đã thanh toán (demo).");
        closeDrawer();
    }
                                        ...
                                        <tr key={o.code}>
                                            ...
                                            <td style={{ textAlign: "right" }}>
                                                <div className="table-actions">
                                                    <button className="icon-btn" title="Xem chi tiết" data-view={o.code} onClick={() => openDrawer(o.code)}>
