...
export class DashboardService {
    ...
    async getStats(rawRange?: string) {
        ...
        const [
            ...
            const lessonProgressCount = await this.prisma.lessonProgress.count({
  ...
  where: {
    ...
    completedAt: { gte: startDate },
        ...
        products.forEach((product) => {
            const viTranslation = product.category?.translations.find((item) => item.languageCode === 'vi' || item.languageCode === 'vi-VN')
