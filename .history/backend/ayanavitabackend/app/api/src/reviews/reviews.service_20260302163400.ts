  ...
  async listPublic(query: PublicReviewsQueryDto) {
    const rows = await this.prisma.review.findMany({
      ...
      include: {
        ...
        product: { select: { id: true, translations: { where: { languageCode: 'vi' }, select: { name: true, slug: true }, take: 1 } } },
