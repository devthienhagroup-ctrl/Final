export class BranchResponseDto {
  ...
  phone?: string | null
  isActive!: boolean
  translations?: Partial<Record<'en' | 'vi' | 'de', { name: string; address: string }>>
}
...
export class ServiceResponseDto {
  ...
  branchIds!: number[]
  isActive!: boolean
  translations?: Partial<Record<'en' | 'vi' | 'de', { name: string; description?: string | null; goals?: string[]; suitableFor?: string[]; process?: string[]; tag?: string | null }>>
}
...
export class SpecialistResponseDto {
  ...
  branchId!: number
  serviceIds!: number[]
  translations?: Partial<Record<'en' | 'vi' | 'de', { name: string; bio?: string | null }>>
}
