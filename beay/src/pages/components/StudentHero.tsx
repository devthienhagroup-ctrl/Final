// src/pages/student/components/StudentHero.tsx
type Props = {
  name: string;
  streakDays: number;
  onEnterLesson: () => void;
      ...
      <div className="flex items-start justify-between gap-6 flex-col lg:flex-row">
        <div className="flex-1">
          ...
          <div className="mt-2 text-slate-600">
            Mục tiêu tuần này: <b>hoàn thành 3 bài học</b> • Chuỗi học:{" "}
            <b>{props.streakDays} ngày</b>.
          </div>
          ...
          <div className="mt-5 grid gap-3 md:grid-cols-3">
            ...
            <div className="p-4 rounded-2xl bg-slate-50 ring-1 ring-slate-200">
              ...
              <div className="mt-1 text-2xl font-extrabold">1</div>
            </div>
          </div>
        </div>
        ...
        <div className="w-full lg:w-[420px] rounded-[18px] border border-slate-200/70 bg-white shadow-[0_10px_30px_rgba(2,6,23,0.06)] p-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <div className="text-sm text-slate-600 mt-1">Bài 08 • State Management (GetX)</div>
            </div>
            <span className="chip">
              <i className="fa-solid fa-stopwatch text-amber-600 mr-1" /> 14 phút
            </span>
          </div>
          ...
          <div className="mt-3 flex gap-2">
            <button className="btn btn-primary flex-1" onClick={props.onEnterLesson}>
              <i className="fa-solid fa-play mr-1" />
              Vào học
            </button>
            <button className="btn" onClick={props.onBookmark}>
